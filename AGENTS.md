...
| `trading.lab` | strategy **research/discovery** harness (was `strategy_lab`): families, immutable releases, point-in-time universes, DuckDB ledger, the evaluation funnel. See `lab/AGENTS.md`. | marketdata |
