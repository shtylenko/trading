...
Usage (the skill's loop):
    ...
    python3 -m trading.day_trading_simulator.feed --ticks F --cursor 0 --wait
    python3 -m trading.day_trading_simulator.feed --ticks F --cursor 1 --wait
    ...
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python -m trading.day_trading_simulator.feed",
