"""Warrior policy v13: scanner watchlist, later pattern-triggered entry."""
...
POLICY_ID = "warrior_pattern_score_v13"
...
def apply_to_session(session_dir: str | Path) -> list[dict[str, Any]]:
    ...
    for field in (
        ...
        "scanner_event_next_open_execution", "scanner_event_watch_until_cutoff",
    ):
