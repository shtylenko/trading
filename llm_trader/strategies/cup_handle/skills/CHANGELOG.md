...
| 0.6.0 | 2026-07-16 | execution safety | Scanner T1/T2 levels are sealed at arm time and the engine owns their exact half/remainder share tranches plus the post-T1 breakeven stop. Agents cannot submit scale orders, eliminating duplicate/wrong-fraction target fills. Audit abandonment now replays deterministic state so a manual or gap/expiry cancel is a valid no-trade outcome. |
