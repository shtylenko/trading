"""Warrior policy v15: 3.0 checklist watch + quality filters + runner retention."""
...
POLICY_ID = "warrior_pattern_score_v15"
...
SETTINGS = v1.PolicySettings(
    ...
    min_pattern_score=10.0,
    max_stop_pct_of_price=0.05,
    failed_break_mode="off",
    runner_exit_mode="off",
)
POLICY_SPEC = {
    **v1.POLICY_SPEC,
    "entry_threshold": 65.0,
