...
def test_finalize_multi_day_uses_stream_bars_not_1min(tmp_path, monkeypatch):
    ...
    lines = [
            ...
            {"type": "tick", "i": 0, "date": "2025-06-16", "time": "16:00",
             ...
             "sma20": 89.0, "sma50": 85.0, "sma200": 80.0, "atr14": 1.2,
             "rvol": 1.1, "above_sma20": True, "above_sma50": True,
             "above_sma200": True, "sma50_rising": True},
            {"type": "tick", "i": 1, "date": "2025-06-17", "time": "16:00",
             "o": 90.5, "h": 92, "l": 90, "c": 91, "v": 1_100_000,
             "sma20": 89.5, "sma50": 85.5, "sma200": 80.1, "atr14": 1.2,
             "rvol": 1.1, "above_sma20": True, "above_sma50": True,
             "above_sma200": True, "sma50_rising": True},
            {"type": "tick", "i": 2, "date": "2025-06-18", "time": "16:00",
             "o": 91, "h": 93, "l": 90.5, "c": 92, "v": 1_200_000,
             "sma20": 90.0, "sma50": 86.0, "sma200": 80.2, "atr14": 1.2,
             "rvol": 1.1, "above_sma20": True, "above_sma50": True,
             "above_sma200": True, "sma50_rising": True, "is_setup_day": True},
...
def test_finalize_multi_day_stamps_fill_dates_from_bars(tmp_path, monkeypatch):
    ...
    lines = [
            ...
            {"type": "tick", "i": 2, "date": "2025-06-23", "time": "16:00",
             ...
             "sma20": 89.0, "sma50": 85.5, "sma200": 80.2, "atr14": 1.2,
             "rvol": 1.1, "above_sma20": False, "above_sma50": True,
             "above_sma200": True, "sma50_rising": True},
