#!/usr/bin/env python3
"""YouTube research: EXIT / HOLDING PERIOD (5 keywords, 20 videos each)."""
...
SAVE_DIR = os.path.join(BASE_DIR, "transcripts", "exit_holding")
os.makedirs(SAVE_DIR, exist_ok=True)

KEYWORDS = {
    "momentum_holding_turnover": "momentum holding period turnover tradeoff",
    "momentum_decay_horizon": "momentum decay horizon",
    "momentum_half_life": "momentum profit half-life",
    "trailing_stop_momentum": "trailing stop momentum stocks",
    "long_term_reversal": "momentum reversal long-term 3-5 year"
}
