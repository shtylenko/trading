...
Usage (from the monorepo root, repo-root .env loaded for provider keys):
    ...
    python3 -m trading.day_trading_simulator.replay                 # random RTH setup
    ...
    python3 -m trading.day_trading_simulator.replay --delay 0.3     # stream ~live
    python3 -m trading.day_trading_simulator.replay --from-open     # start at 09:30, not entry
    python3 -m trading.day_trading_simulator.replay --format jsonl --out-file ticks.jsonl
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python -m trading.day_trading_simulator.replay",
