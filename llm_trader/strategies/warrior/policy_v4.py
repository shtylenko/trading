"""Warrior policy v4: v3 early-session selection with an 85-point entry floor."""
...
POLICY_ID = "warrior_pattern_score_v4"
DECISION_SOURCE = "deterministic_policy"
USES_SESSION_EXECUTION_CONFIG = True
SETTINGS = v1.PolicySettings(entry_threshold=85.0, entry_cutoff="10:00")
POLICY_SPEC = {
    **v1.POLICY_SPEC,
...
def _v4_identity(record: dict[str, Any]) -> dict[str, Any]:
    out = dict(record)
