"""Warrior policy v10: scanner-event-minute confirmation only."""
from __future__ import annotations
from pathlib import Path
from typing import Any, Iterable, Mapping
from ...execution import EXECUTION_MODEL, ExecutionConfig
from . import policy as v1
POLICY_ID='warrior_pattern_score_v10';DECISION_SOURCE='deterministic_policy';USES_SESSION_EXECUTION_CONFIG=True
SETTINGS=v1.PolicySettings(entry_threshold=70.0,entry_cutoff='11:00',exit_threshold=70.0,scanner_event_required=True,scanner_event_immediate_confirmation=True,scanner_event_confirmation_bars=0)
POLICY_SPEC={**v1.POLICY_SPEC,'entry_threshold':70.0,'entry_cutoff':'11:00','exit_threshold':70.0,'scanner_event_required':True,'scanner_event_immediate_confirmation':True,'scanner_event_confirmation_bars':0,'complete_five_minute_bars_required':True,'policy_generation':10}
