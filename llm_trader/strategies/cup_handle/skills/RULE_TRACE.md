...
|---|---|---|---|---|
| plan.uptrend_sma_stack | ENTRY checklist §1 | operationalization | close > SMA20/50/200; SMA50 rising or stacked vs SMA200 | 0.1.0 |
| plan.cup_geometry | ENTRY checklist §2 | operationalization | depth 12–35%, multi-bar trough, lips within 5% | 0.1.0 |
| plan.handle_tight | ENTRY checklist §3 | operationalization | short shallow handle under lip, light volume | 0.1.0 |
| plan.room_to_run | ENTRY checklist §4 | operationalization | no stacked supply just above handle high | 0.1.0 |
| entry.break_handle_high | ARM_BUY_STOP | direct | buy when price breaks handle high | 0.1.0 |
