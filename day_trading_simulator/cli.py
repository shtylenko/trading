"""CLI argument parsing for the entry scanner.
    ...
    python -m trading.day_trading_simulator.runner \\
        --start 2025-01-01 --end 2026-06-30 --profile small

    # quick pipeline smoke test on a slice / explicit tickers
    python -m trading.day_trading_simulator.runner --max-symbols 50
    python -m trading.day_trading_simulator.runner --symbols AAOI TLRY GME
"""
