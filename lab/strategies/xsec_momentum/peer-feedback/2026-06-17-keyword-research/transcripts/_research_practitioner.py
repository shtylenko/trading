#!/usr/bin/env python3
"""YouTube research: PRACTITIONER / IMPLEMENTATION (5 keywords, 20 videos each)."""
...
SAVE_DIR = os.path.join(BASE_DIR, "transcripts", "practitioner")
os.makedirs(SAVE_DIR, exist_ok=True)

KEYWORDS = {
    "momentum_backtest_python": "momentum strategy backtest python",
    "wesley_gray_alpha_architect": "quantitative momentum Wesley Gray Alpha Architect",
    "dual_momentum_antonacci": "dual momentum Gary Antonacci",
    "momentum_transaction_costs": "momentum transaction costs implementation shortfall",
    "factor_momentum_smart_beta": "factor momentum smart beta ETF construction"
}
...
with open(os.path.join(SAVE_DIR, "_FINDINGS.md"), 'w') as f:
    f.write("# Practitioner / Implementation — YouTube Research Findings\n\nGenerated: 2026-06-17\n\n")
